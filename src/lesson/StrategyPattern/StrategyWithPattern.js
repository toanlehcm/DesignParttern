export default function StrategyWithPattern(originalPrice, typePromotion) {
  /**
 ...
 */
  ...
  */
  ...
  function getPrice2(originalPrice, typePromotion) {
  ...
  return (
    <>
      <div>StrategyWithPattern</div>
      <div>{getPrice(200, 'default')}</div>
      <div>{getPrice(200, 'blackFriday')}</div>
    </>
  );
}
